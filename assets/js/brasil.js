...
document.addEventListener('DOMContentLoaded', async () => {
  const weatherSP = await fetch(`https://corsproxy.io/?https://api.weatherapi.com/v1/forecast.json?key=${apiKey}&q=Sao Paulo&lang=pt`);
  ...
  const weatherRJ = await fetch(`https://corsproxy.io/?https://api.weatherapi.com/v1/forecast.json?key=${apiKey}&q=Rio de Janeiro&lang=pt`)
  ...
  const weatherMG = await fetch(`https://corsproxy.io/?https://api.weatherapi.com/v1/forecast.json?key=${apiKey}&q=Minas Gerais&lang=pt`)
